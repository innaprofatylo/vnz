...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass: "ba-form",
      attrs: { action: "#", method: " post", id: "testform" },
      on: {
        submit: function($event) {
          $event.preventDefault()
          return _vm.getAnswers($event)
        }
      }
    },
    [
      ...
      _c(
        "a",
        {
          staticClass: "ba-button ba-button--test",
          attrs: { id: "btn", href: "result-test.html" }
        },
...
/* harmony import */ var _test__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./test */ "./src/assets/js/test.js");
